...
如同之前的操作，指定好官方的[phpMyAdmin image](https://hub.docker.com/r/phpmyadmin/phpmyadmin/)。我們發佈的port 80對應到虛擬機的8080，以及連結`mysql` Container。最後設定`PMA_HOST`環境變數。
